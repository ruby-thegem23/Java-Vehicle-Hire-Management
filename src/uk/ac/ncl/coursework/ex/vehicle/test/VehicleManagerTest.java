...
public class VehicleManagerTest{
        ...
        private void addCustomerUniqueness() {
            ...
            CustomerRecord c1 = vm.addCustomerRecord("Ruby", "Han", dob, false);
            Assertions.assertTrue(vm.getCustomers().containsKey(c1.getCustomerID()));
        ...
        private void rulesOfHiredVehicles() {
            ...
            vm.addVehicle("van");
            CustomerRecord crv = vm.addCustomerRecord("Ruby", "Hon",
                    makeDob(2020, Calendar.NOVEMBER, 25), false);

            Assertions.assertFalse(vm.hireVehicle(crv, "van", 1));
            ...
            Assertions.assertFalse(vm.hireVehicle(hasCommercial, "van", 1));
